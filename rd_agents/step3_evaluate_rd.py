...
def main():
    parser = argparse.ArgumentParser(
        description="Evaluate ORPHA code predictions across a corpus"
    )
    ...
    if args.enable_fuzzy:
        ...
        # Process predictions
        for doc_id, doc_data in predictions_data.get(
            "results", predictions_data
        ).items():
    ...
    print(
        f"  TP/FP/FN: {exact_result['count_based_metrics']['tp_count']}/{exact_result['count_based_metrics']['fp_count']}/{exact_result['count_based_metrics']['fn_count']}"
    )
    ...
    if args.enable_fuzzy:
        ...
        print(
            f"  TP/FP/FN: {fuzzy_result['tp_count']}/{fuzzy_result['fp_count']}/{fuzzy_result['fn_count']}"
        )
