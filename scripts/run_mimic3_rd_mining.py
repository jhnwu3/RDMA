...
def main():
    ...
    dataset = MIMIC3Dataset(root=args.mimic3_root, tables=["noteevents"], num_workers=4)
    ...
    try:
        ...
        for i, sample in enumerate(tqdm(run_samples, total=len(run_samples), desc="MIMIC3-RD")):
            try:
            ...
            try:
                ...
                predicted_orpha_ids = [
                    format_orpha_id(m.get("orpha_id", ""))
                    for m in matched
                ]
            except Exception as e:
