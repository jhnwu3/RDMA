#!/usr/bin/env python3
"""
i2b2 NER baseline for the CSC phenotype-mining benchmark.
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="i2b2 NER baseline on CSC phenotype-mining benchmark"
    )
    parser.add_argument(
        "--dataset_cache_dir",
        type=str,
    ...
    try:
        ...
        for i, sample in enumerate(
            tqdm(run_samples, total=len(run_samples), desc="CSC-i2b2")
        ):
            try:
