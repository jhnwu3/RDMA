...
class MultiStageHPOVerifierV3(MultiStageHPOVerifierV4):
    ...
    def __init__(self, embedding_manager, llm_client, config=None, debug=False):
        ...
        super().__init__(embedding_manager, llm_client, config, debug, lab_embeddings_file=None)
...
class MultiStageHPOVerifierV2(MultiStageHPOVerifierV4):
    ...
    def __init__(self, embedding_manager, llm_client, config=None, debug=False, lab_embeddings_file=None):
        """Initialize with more verbose system prompts."""
        # Call parent initializer first
        super().__init__(embedding_manager, llm_client, config, debug, lab_embeddings_file)
